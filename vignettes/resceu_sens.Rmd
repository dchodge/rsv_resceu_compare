...
```{r}
outcomes_tot <- get_summarise_outputs(outputNone, sens_list)
outcomes_tot_b1 <- get_summarise_outputs(outputBase_mab, sens_list)
com <- outcomes_tot - outcomes_tot_b1
get_QALY_sens(com, sens_list)
get_QALY_sens(outcomes_tot_b1, sens_list)

get_cost_indirect(outcomes_tot, sens_list)


get_cost_treat(com, sens_list)
get_cost_indirect(com, sens_list)
get_cost_inter(outputBase_mab$vac_cal, sens_list, TRUE)
...
get_qaly_cost(outputNone, sens_list, base = TRUE)
get_qaly_cost(outputBase_mab, sens_list, base = FALSE)
